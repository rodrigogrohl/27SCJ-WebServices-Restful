 ...
 * 
 */
@WebServiceClient(name = "AlunoWebService", targetNamespace = "http://ws.exemplos.fiap.br/", wsdlLocation = "http://l2901micro40:8080/Exemplo3/AlunoWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ALUNOWEBSERVICE_QNAME = new QName("http://ws.exemplos.fiap.br/", "AlunoWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://l2901micro40:8080/Exemplo3/AlunoWebService?wsdl");
    ...
    public AlunoWeb getAlunoWebPort() {
        return super.getPort(new QName("http://ws.exemplos.fiap.br/", "AlunoWebPort"), AlunoWeb.class);
    }
    ...
    public AlunoWeb getAlunoWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.exemplos.fiap.br/", "AlunoWebPort"), AlunoWeb.class, features);
    }
