 ...
 * generated in the br.com.fiap.ws.clientsoap package. 
...
public class ObjectFactory {
    ...
    private final static QName _Password_QNAME = new QName("http://ws.exemplos.fiap.br/", "Password");
    ...
    private final static QName _Username_QNAME = new QName("http://ws.exemplos.fiap.br/", "Username");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.com.fiap.ws.clientsoap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.exemplos.fiap.br/", name = "Password")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.exemplos.fiap.br/", name = "Username")
