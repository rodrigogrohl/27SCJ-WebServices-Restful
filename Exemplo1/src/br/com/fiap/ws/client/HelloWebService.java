 ...
 * 
 */
@WebServiceClient(name = "HelloWebService", targetNamespace = "http://ws.fiap.com.br/", wsdlLocation = "http://localhost:8080/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICE_QNAME = new QName("http://ws.fiap.com.br/", "HelloWebService");
    ...
    public HelloWeb getHelloWebPort() {
        return super.getPort(new QName("http://ws.fiap.com.br/", "HelloWebPort"), HelloWeb.class);
    }
    ...
    public HelloWeb getHelloWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.fiap.com.br/", "HelloWebPort"), HelloWeb.class, features);
    }
